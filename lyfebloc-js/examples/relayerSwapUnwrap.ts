...
import { LyfeblocSDK, Network, LyfeblocSdkConfig } from '../src/index';
import { FundManagement } from '../src/modules/swaps/types';

import lyfeblocRelayerAbi from '../src/lib/abi/LyfeblocRelayer.json';
...
Reserve must have approvals for tokens
*/
async function runRelayerSwapUnwrapExactIn() {
  ...
  const txInfo = await lyfebloc.relayer.swapUnwrapAaveStaticExactIn(
...
async function runRelayerSwapUnwrapExactOut() {
  ...
  const txInfo = await lyfebloc.relayer.swapUnwrapAaveStaticExactOut(
    [bbausd, bbausd, bbausd],
    [
      '0x02d60b84491589974263d922d9cc7a3152618ef6', // waDAI
      '0xd093fa4fb80d09bb30817fdcd442d4d02ed3e5de', // waUSDC
