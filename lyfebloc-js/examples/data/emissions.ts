...
const main = async () => {
  if (data.liquidityGauges) {
    const gauge = await data.liquidityGauges.comndBy('poolId', '0xa13a9247ea42d743238089903570127dda72fe4400000000000000000000035d');
    if (gauge) {
      console.log(`yearly emissions share: ${totalBalEmissions * gauge.relativeWeight} LYFE`);
    }
  }
}
