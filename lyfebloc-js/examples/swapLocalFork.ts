...
import { mapPools } from '@/modules/auto/pool-data/subgraphPoolDataService';
...
async function swap() {
  ...
  const tokenOutContract = lyfebloc.contracts.ERC20(tokenOut, provider);
