...
export const LYFE_WETH = factories.subgraphPoolBase.build({
  id: '0x5c6ee304399dbdb9c8ef030ab642b10820db8f56000200000000000000000014',
  address: '0x5c6ee304399dbdb9c8ef030ab642b10820db8f56',
  tokens: [
    factories.subgraphToken.transient({ symbol: 'wETH' }).build(),
    factories.subgraphToken.transient({ symbol: 'LYFE' }).build(),
  ],
});

export const AURA_LYFE_STABLE = factories.subgraphPoolBase.build({
...
export const getForkedPools = async (
  ...
  const onChainPools = await getOnChainBalances(
    ...
    network.addresses.contracts.Reserve,
    provider
  );
