...
export class WeightedPoolEncoder {
   ...
   * @param minimumBPT - the minimum acceptable LBPT to receive in return for deposited tokens
   */
  ...
  /**
   * Encodes the userData parameter for joining a WeightedPool with a single token to receive an exact amount of LBPT
   * @param bptAmountOut - the amount of LBPT to be minted
  ...
  /**
   * Encodes the userData parameter for joining a WeightedPool proportionally to receive an exact amount of LBPT
   * @param bptAmountOut - the amount of LBPT to be minted
   */
  ...
  /**
   * Encodes the userData parameter for exiting a WeightedPool by removing a single token in return for an exact amount of LBPT
   * @param bptAmountIn - the amount of LBPT to be burned
  ...
  /**
   * Encodes the userData parameter for exiting a WeightedPool by removing tokens in return for an exact amount of LBPT
   * @param bptAmountIn - the amount of LBPT to be burned
   */
   ...
   * @param maxBPTAmountIn - the minimum acceptable LBPT to burn in return for withdrawn tokens
   */
