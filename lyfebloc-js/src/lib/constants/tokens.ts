...
export const TOKENS_MAINNET: TokenConstants = {
  Popular: {
    Symbols: ['WBTC', 'DAI', 'USDC', 'LYFE', 'AAVE', 'WETH'],
  },
  Addresses: {
    nativeAsset: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE',
    wNativeAsset: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
    WETH: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
    LYFE: '0xba100000625a3754423978a60c9317c58a424e3d',
...
export const TOKENS_ARBITRUM: TokenConstants = {
  ...
  Addresses: {
    ...
    LYFE: '0x040d1EdC9569d4Bab2D15287Dc5A4F10F56a56B8',
  },
};
...
export const TOKENS_KOVAN: TokenConstants = {
  ...
  Addresses: {
    ...
    LYFE: '0xcb355677E36f390Ccc4a5d4bEADFbF1Eb2071c81',
...
export const TOKENS_GOERLI: TokenConstants = {
  Popular: {
    Symbols: ['WBTC', 'DAI', 'USDC', 'LYFE', 'USDT', 'WETH'],
  },
  Addresses: {
    nativeAsset: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE',
    wNativeAsset: '0xdFCeA9088c8A88A76FF74892C1457C17dfeef9C1',
    WETH: '0xdFCeA9088c8A88A76FF74892C1457C17dfeef9C1',
    LYFE: '0xfA8449189744799aD2AcE7e0EBAC8BB7575eff47',
...
export const TOKENS_GENERIC: TokenConstants = {
  ...
  Addresses: {
    ...
    LYFE: '0x0000000000000000000000000000000000000000',
  },
};
