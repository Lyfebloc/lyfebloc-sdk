 ...
 * makes proportional exits using a user's total LBPT balance impossible. In
...
const POOLS_KOVAN: Pools = {
  IdsMap: {
    ...
    veLYFE: '0xdc2ecfdf2688f92c85064be0b929693acc6dbca6000200000000000000000701',
  },
  Pagination: {
    PerPage: 10,
    PerPool: 10,
  ...
  Metadata: {
    '0x8fd162f338b770f7e879030830cde9173367f3010000000000000000000004d8': {
      name: 'Lyfebloc Boosted Aave USD',
      hasIcon: false,
    },
    '0xd387dfd3a786e7caa06e6cf0c675352c7ffff30400000000000000000000063e': {
      name: 'Lyfebloc Stable USD',
      hasIcon: false,
    },
  },
};
...
const POOLS_GOERLI: Pools = {
  IdsMap: {
    ...
    veLYFE: '0xf8a0623ab66f985effc1c69d05f1af4badb01b00000200000000000000000060',
  },
  Pagination: {
    PerPage: 10,
    PerPool: 10,
...
const POOLS_MAINNET: Pools = {
  IdsMap: {
    ...
    veLYFE: '0x5c6ee304399dbdb9c8ef030ab642b10820db8f56000200000000000000000014',
  },
  Pagination: {
    PerPage: 10,
    PerPool: 10,
