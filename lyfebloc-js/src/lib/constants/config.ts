...
import { LyfeblocNetworkConfig } from '@/types';

export const lyfeblocReserve = '0xBA12222222228d8Ba445958a75a0704d566BF2C8';

export const LYFEBLOC_NETWORK_CONFIG: Record<Network, LyfeblocNetworkConfig> = {
  [Network.MAINNET]: {
    ...
    addresses: {
      contracts: {
        ...
        lyfeblocHelpers: '0x5aDDCCa35b7A0D07C74063c48700C8590E87864E',
        ...
        veLyfe: '0xC128a9954e6c874eA3d62ce62B468bA073093F25',
        veLyfeProxy: '0x6f5a2eE11E7a772AeB5114A20d0D7c0ff61EB8A0',
    ...
    urls: {
      ...
      gaugesSubgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-gauges',
      blockNumberSubgraph:
  ...
  [Network.POLYGON]: {
    ...
    addresses: {
      contracts: {
        ...
        lyfeblocHelpers: '0x239e55F427D44C3cc793f49bFB507ebe76638a2b',
    ...
    urls: {
      ...
      gaugesSubgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-gauges-polygon',
      blockNumberSubgraph:
  ...
  [Network.ARBITRUM]: {
    ...
    addresses: {
      contracts: {
        ...
        lyfeblocHelpers: '0x77d46184d22CA6a3726a2F500c776767b6A3d6Ab',
    ...
    urls: {
      subgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-arbitrum-v2',
      gaugesSubgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-gauges-arbitrum',
      blockNumberSubgraph:
  ...
  [Network.KOVAN]: {
    ...
    addresses: {
      contracts: {
        ...
        veLyfe: '0x16ba924752EF283C7946db8A122a6742AA35C1DC',
        veLyfeProxy: '0x98D0d0a65cBeCCaa647a5a95cf27Cf2f00E1231C',
        lyfeblocHelpers: '0x94905e703fEAd7f0fD0eEe355D267eE909784e6d',
        weightedPoolFactory: '0x8df6EfEc5547e31B0eb7d1291B511FF8a2bf987c',
      },
      tokens: {
  ...
  [Network.RINKEBY]: {
    ...
    urls: {
      subgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-rinkeby-v2',
      gaugesSubgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-gauges',
    },
    pools: {},
  ...
  [Network.GOERLI]: {
    ...
    addresses: {
      contracts: {
        ...
        veLyfe: '0x33A99Dcc4C85C014cf12626959111D5898bbCAbF',
        veLyfeProxy: '0xA1F107D1cD709514AE8A914eCB757E95f9cedB31',
        lyfeblocHelpers: '0x5aDDCCa35b7A0D07C74063c48700C8590E87864E',
        weightedPoolFactory: '0x8E9aa87E45e92bad84D5F8DD1bff34Fb92637dE9',
        composableStablePoolFactory:
          '0x85a80afee867adf27b50bdb7b76da70f1e853062',
    ...
    urls: {
      ...
      gaugesSubgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-gauges-goerli',
      blockNumberSubgraph:
  ...
  [Network.OPTIMISM]: {
    ...
    addresses: {
      contracts: {
        ...
        lyfeblocHelpers: '0x8E9aa87E45e92bad84D5F8DD1bff34Fb92637dE9',
        weightedPoolFactory: '0x0e39C3D9b2ec765eFd9c5c70BB290B1fCD8536E3',
        composableStablePoolFactory:
          '0x85a80afee867adf27b50bdb7b76da70f1e853062',
      },
  ...
  [Network.GNOSIS]: {
    ...
    urls: {
      subgraph:
        'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-gnosis-chain-v2',
      gaugesSubgraph: '',
    },
    pools: {},
  },
...
export const networkAddresses = (
  chainId: number
): LyfeblocNetworkConfig['addresses'] =>
  LYFEBLOC_NETWORK_CONFIG[chainId as Network].addresses;
