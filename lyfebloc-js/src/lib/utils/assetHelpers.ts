...
export class AssetHelpers {
  ...
  /**
   * Sorts an array of token addresses into ascending order to match the format expected by the Reserve.
   *
   ...
   * This matches the behaviour expected by the Reserve when receiving an array of addresses.
   *
