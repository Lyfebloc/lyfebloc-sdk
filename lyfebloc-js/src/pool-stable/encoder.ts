...
export class StablePoolEncoder {
  ...
  /**
   * Encodes the userData parameter for joining a StablePool with to receive an exact amount of LBPT
  ...
  /**
   * Encodes the userData parameter for exiting a StablePool by removing a single token in return for an exact amount of LBPT
  ...
  /**
   * Encodes the userData parameter for exiting a StablePool by removing tokens in return for an exact amount of LBPT
   * @param bptAmountIn - the amount of LBPT to be burned
   */
