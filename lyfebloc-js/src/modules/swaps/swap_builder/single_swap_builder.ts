...
class SingleSwapBuilder {
   ...
   * https://dev.lyfebloc.com/guides/swaps/single-swaps
   * https://dev.lyfebloc.com/resources/swaps/single-swap
   *
   * For swap:
  ...
  attributes(): Swap {
    ...
    // https://github.com/lyfebloc/lyfebloc-v2-monorepo/blob/master/pkg/standalone-utils/contracts/relayer/ReserveActions.sol#L44
