import { decorateAutoSwapInfo } from './swap_info_decorator';
...
describe('decorated SwapInfo', () => {
  ...
  context('SwapExactIn', () => {
    const sdkSwapInfo = decorateAutoSwapInfo(swapInfo, SwapType.SwapExactIn);
  ...
  context('SwapExactOut', () => {
    const sdkSwapInfo = decorateAutoSwapInfo(swapInfo, SwapType.SwapExactOut);
