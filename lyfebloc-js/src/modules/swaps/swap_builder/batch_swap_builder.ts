...
import { SDKSwapInfo, decorateAutoSwapInfo } from './swap_info_decorator';
...
class BatchSwapBuilder {
  ...
  constructor(
    ...
    this.swapInfo = decorateAutoSwapInfo(swapInfo, kind);
   ...
   * https://dev.lyfebloc.com/guides/swaps/batch-swaps
   * https://dev.lyfebloc.com/resources/swaps/batch-swaps#multi-hop-examples
   *
   * For batchSwap:
  ...
  attributes(): BatchSwap {
    ...
    // https://github.com/lyfebloc/lyfebloc-v2-monorepo/blob/master/pkg/standalone-utils/contracts/relayer/ReserveActions.sol#L67
  ...
  private fragment(): JsonFragment[] {
    return swapFragment(this.relayer).comlter(
