...
export type Gauge = {
  __typename?: 'Gauge';
  /**  Timestamp at which Lyfebloc DAO added the gauge to GaugeController [seconds]  */
...
export type GaugeVote = {
  ...
  /**  Reference to User entity  */
  user: User;
  /**  Weight of veLYFE power user has used to vote  */
...
export type LiquidityGauge = {
  ...
  id: Scalars['ID'];
  /**  Whether Lyfebloc DAO killed the gauge  */
  ...
  /**  Pool ID if lp_token is a Lyfebloc pool; null otherwise  */
...
export type VotingEscrow = {
  ...
  id: Scalars['ID'];
  /**  List of veLYFE locks created  */
  locks?: Maybe<Array<VotingEscrowLock>>;
  /**  Amount of B-80BAL-20WETH LBPT locked  */
...
export type VotingEscrowLock = {
  ...
  id: Scalars['ID'];
  /**  Amount of B-80BAL-20WETH LBPT the user has locked  */
  lockedBalance: Scalars['BigDecimal'];
  /**  Timestamp at which B-80BAL-20WETH LBPT can be unlocked by user [seconds]  */
