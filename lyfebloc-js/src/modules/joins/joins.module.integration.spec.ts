...
const customSubgraphUrl =
  'https://api.thegraph.com/subgraphs/name/lyfebloc/lyfebloc-goerli-v2-beta';
...
const tenderlyConfig: LyfeblocTenderlyConfig = {
...
const testFlow = async (
  ...
  console.log(bptBalanceAfter.toString(), 'LBPT after');
  ...
  */
  context('boostedWeightedSimple', async () => {
    ...
    beforeEach(async () => {
      ...
      const balances = [
        parseFixed('10', addresses.LYFE.decimals).toString(),
        parseFixed('10', addresses.WETH.decimals).toString(),
        '0',
    ...
    await runTests([
      {
        ...
        tokensIn: [addresses.LYFE.address, addresses.WETH.address],
        amountsIn: [
          parseFixed('10', addresses.LYFE.decimals).toString(),
          parseFixed('10', addresses.WETH.decimals).toString(),
        ],
      ...
      // },
      {
        ...
        tokensIn: [addresses.LYFE.address, addresses.bbaweth.address],
        amountsIn: [
          parseFixed('1', addresses.LYFE.decimals).toString(),
