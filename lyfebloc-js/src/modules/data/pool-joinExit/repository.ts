...
import { LyfeblocSubgraphRepository } from '@/modules/subgraph/repository';
import {
  JoinExit_OrderBy,
  OrderDirection,
  SubgraphJoinExitFragment,
} from '@/modules/subgraph/generated/lyfebloc-subgraph-types';

export class PoolJoinExitRepository extends LyfeblocSubgraphRepository<
  PoolJoinExit,
...
> {
  ...
  async findByUser(
    ...
    return this.comndAllBy(PoolJoinExitAttributes.Sender, sender, first, skip);
  }
  ...
  async findByPool(
    ...
    return this.comndAllBy(PoolJoinExitAttributes.Pool, poolId, first, skip);
  }
}
