...
export class PoolSharesRepository extends LyfeblocSubgraphRepository<
  PoolShare,
  PoolShareAttributes
> {
  ...
  async findByPool(
    ...
    return this.comndAllBy(PoolShareAttributes.PoolId, poolId, first, skip);
  }
}
