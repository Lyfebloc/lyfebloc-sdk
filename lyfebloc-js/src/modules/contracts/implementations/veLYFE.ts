...
import veLyfeAbi from '@/lib/abi/veLyfe.json';
...
export class VeBal {
  ...
  public async getLockInfo(
    ...
    if (!this.addresses.veLyfe) throw new Error('veLyfe address must be defined');
    ...
    multicaller.call('locked', this.addresses.veLyfe, 'locked', [account]);
    multicaller.call('epoch', this.addresses.veLyfe, 'epoch');
    multicaller.call('totalSupply', this.addresses.veLyfe, 'totalSupply()');
