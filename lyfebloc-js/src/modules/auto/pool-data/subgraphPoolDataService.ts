import { PoolDataService, SubgraphPoolBase } from '@lyfebloc/auto';
import {
  OrderDirection,
  Pool_OrderBy,
  SubgraphClient,
...
import { LyfeblocNetworkConfig, LyfeblocSdkAutoConfig } from '@/types';
...
export class SubgraphPoolDataService implements PoolDataService {
  constructor(
    ...
    private readonly network: LyfeblocNetworkConfig,
    private readonly autoConfig: LyfeblocSdkAutoConfig
  ) {}
  ...
  public async getPools(): Promise<SubgraphPoolBase[]> {
    ...
    if (this.autoConfig.fetchOnChainBalances === false) {
      return mapped;
    }
    ...
    return getOnChainBalances(
      ...
      this.network.addresses.contracts.Reserve,
      this.provider
    );
  }
