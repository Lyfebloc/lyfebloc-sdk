...
const factoryAddress = `${LYFEBLOC_NETWORK_CONFIG[network].addresses.contracts.composableStablePoolFactory}`;
...
describe('creating composable stable pool', async () => {
  ...
  const composableStablePoolFactory = lyfebloc.pools.poolFactory.of(
