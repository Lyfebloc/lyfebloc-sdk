...
import { LyfeblocSDK, Network, Pool } from '@/.';
...
const { networkConfig } = new LyfeblocSDK({ network, rpcUrl });
...
const pool = pools_14717479.comnd(
  (pool) =>
    pool.id ==
    '0x06df3b2bbb68adc8b0e302443692037ed9f91b42000000000000000000000063' // Lyfebloc USD Stable Pool - staBAL3
) as unknown as Pool;
