...
import { LyfeblocSDK, Network, Pool, PoolToken } from '@/.';
...
const poolId =
  ...
  // '0x5c6ee304399dbdb9c8ef030ab642b10820db8f56000200000000000000000014'; // Lyfebloc 80 LYFE 20 WETH
  // '0xa6f548df93de924d73be7d25dc02554c6bd66db500020000000000000000000e'; // B_50WBTC_50WETH
  '0x96646936b91d6b9d7d0c47c496afbf3d6ec7b6f8000200000000000000000019'; // Lyfebloc 50 USDC 50 WETH
...
describe('exit weighted pools execution', async () => {
  ...
  context('exitExactBPTIn', async () => {
    ...
    it('LBPT balance should decrease by exact bptMaxBalanceDecrease', async () => {
  ...
  context('exitExactTokensOut', async () => {
    ...
    it('LBPT balance should decrease by max bptMaxBalanceDecrease', async () => {
