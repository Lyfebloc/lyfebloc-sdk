...
export interface ExitConcern {
  /**
   * Build exit pool transaction parameters with exact LBPT in and minimum token amounts out based on slippage tolerance
   * @param exiter Account address exiting pool
   * @param pool Pool being exited
   * @param bptIn LBPT provided for exiting pool
  ...
  /**
   * Build exit pool transaction parameters with exact tokens out and maximum LBPT in based on slippage tolerance
   * @param exiter Account address exiting pool
   * @param pool Pool being exited
